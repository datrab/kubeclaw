import type { AGENT_OBSERVABILITY_DIAGNOSTICS, AGENT_OBSERVABILITY_HOOKS, AGENT_OBSERVABILITY_INGRESS_EVENT_TYPES } from './constants.ts';
...
export type AgentObservabilityCanonicalTelemetryType = 'agent.ended' | 'agent.spawn.requested' | 'agent.spawned' | 'agent.delivery.target' | 'agent.subagent.ended' | 'agent.tool.started' | 'agent.tool.finished' | 'agent.model.started' | 'agent.model.ended' | 'agent.session.started' | 'agent.session.ended' | 'agent.llm.input.summary' | 'agent.llm.output.summary' | 'cost.update' | 'plugin.event';
export type AgentObservabilityJsonValue = null | string | number | boolean | AgentObservabilityJsonValue[] | {
    [key: string]: AgentObservabilityJsonValue;
};
...
export interface AgentObservabilityHistoryMessageV1 {
    ...
    name?: string;
    tool_call_id?: string;
    metadata?: Record<string, AgentObservabilityJsonValue>;
}
...
export interface AgentObservabilityLlmInputPayloadV1 extends AgentObservabilityPayloadBaseV1 {
    ...
    model?: string | null;
    request?: Record<string, AgentObservabilityJsonValue>;
}
export interface AgentObservabilityLlmOutputPayloadV1 extends AgentObservabilityPayloadBaseV1 {
    ...
    provider?: string | null;
    model?: string | null;
    usage?: Record<string, AgentObservabilityJsonValue>;
}
...
export interface AgentObservabilityModelUsagePayloadV1 extends AgentObservabilityPayloadBaseV1 {
    ...
    duration_ms?: number | null;
    context?: Record<string, AgentObservabilityJsonValue>;
    usage?: Record<string, AgentObservabilityJsonValue>;
}
...
export type AgentObservabilityIngressPayloadV1 = AgentObservabilityLlmInputPayloadV1 | AgentObservabilityLlmOutputPayloadV1 | AgentObservabilityAgentEndedPayloadV1 | AgentObservabilityToolStartedPayloadV1 | AgentObservabilityToolFinishedPayloadV1 | AgentObservabilityModelStartedPayloadV1 | AgentObservabilityModelEndedPayloadV1 | AgentObservabilityModelUsagePayloadV1 | AgentObservabilitySubagentPayloadV1 | AgentObservabilitySessionPayloadV1;
