...
export const AGENT_OBSERVABILITY_SOURCE = 'openclaw.plugin.agent-observer';
export const AGENT_OBSERVABILITY_CONTROL_STREAM = 'pipeline:agent-observability:control:v1';
export const AGENT_OBSERVABILITY_PAYLOAD_STREAM = 'pipeline:agent-observability:payload:v1';
export const AGENT_OBSERVABILITY_DEADLETTER_STREAM = 'pipeline:agent-observability:deadletter:v1';
export const AGENT_OBSERVABILITY_REDIS_DATA_FIELD = 'data';
export const AGENT_OBSERVABILITY_ABSOLUTE_MAX_EVENT_BYTES = 5 * 1024 * 1024;
export const AGENT_OBSERVABILITY_PAYLOAD_TOO_LARGE_REASON = 'agent_observability_payload_too_large';
