...
if (phase === 'produce') await produce(); else if (['consume-en', 'consume-cs', 'consume-da', 'consume-tr', 'consume-sv',
  ...
  'consume-missing'].includes(phase)) await consume(); else throw new Error(`unknown phase: ${phase}`);
