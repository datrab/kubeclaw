...
function materializeCore(destination, historical) {
  ...
  for (const file of archive.files) {
    ...
    if (!historical && file.path !== producerPath) continue;
...
export function materializeLegacyCore(destination) { return materializeCore(destination, true); }
export function materializeCurrentCore(destination) { return materializeCore(destination, false); }
