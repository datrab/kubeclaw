                  ...
                  return {
                    ...
                    diagnostics: {
                      ...
                      metadata: {
                        ...
                        poll_result: { ok: false, reason: 'session_ended_no_changes', status: { detail: `mixed many-module Forge retry ${moduleId}` } },
                  ...
                  diagnostics: {
                    ...
                    metadata: {
                      ...
                      poll_result: {
                        ...
                        status: { status: 'READY_FOR_TESTING', summary: `Forge passed ${moduleId}` },
                      },
                    ...
                    diagnostics: {
                      summary: `Buster produced retryable FAIL for ${moduleId}`,
	                      metadata: {
	                        ...
	                        poll_result: { ok: true, status: { status: 'FAIL', failure_class: 'verdict_fail' } },
