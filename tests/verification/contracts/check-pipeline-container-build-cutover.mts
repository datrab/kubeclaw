...
assert.doesNotMatch(secretSetup, /pipeline_source_attestation|pipeline-test-gate-source-attestation/u);
assert.doesNotMatch(busterValues, /buster-plan-tls|pipeline-test-gate-source-attestation/u);
...
assert.doesNotMatch(novaValues, /NODE_EXTRA_CA_CERTS|buster-plan-trust|SOURCE_ATTESTATION/u);
