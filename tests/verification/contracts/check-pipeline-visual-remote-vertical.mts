...
try{
  ...
  try{
    ...
    const executed=await gate.execute({idempotencyKey:'visual:remote:vertical',pipelineStageId:'stage:visual',plan,repositoryRoot:repository,repositoryId:'repository:visual',maximumConcurrency:1,grants:new Map([['visual',['browser.visual']]]),submittedAt:'2026-09-03T00:00:00.000Z',timeoutMs:180000,legacySuites:[]});
