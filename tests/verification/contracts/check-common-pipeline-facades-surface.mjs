...
const APPROVED_COMMON_FACADES = Object.freeze([
  ...
  'skills/buster/pipeline/agents/session-handoff.ts',
  ...
  'skills/buster/pipeline/completion.ts',
  ...
  'skills/buster/pipeline/integrations/git-worktree.ts',
  'skills/buster/pipeline/lifecycle-state.ts',
  'skills/buster/pipeline/noncritical-reporting.ts',
  'skills/buster/pipeline/optional-absence.ts',
  'skills/buster/pipeline/observability-contract.ts',
  'skills/buster/pipeline/portable-artifacts.ts',
  'skills/buster/pipeline/platform-config.ts',
  'skills/buster/pipeline/egress.ts',
  'skills/buster/pipeline/redis-transport.ts',
  'skills/buster/pipeline/run-discovery.ts',
  'skills/buster/pipeline/runtime-state-paths.ts',
  'skills/buster/pipeline/security.ts',
  'skills/buster/pipeline/scheduler.ts',
  ...
  'skills/buster/pipeline/services/redis-wait.ts',
  ...
  'skills/nova/pipeline/agents/session-handoff.ts',
  ...
  'skills/nova/pipeline/completion.ts',
  ...
  'skills/nova/pipeline/optional-absence.ts',
  'skills/nova/pipeline/observability-contract.ts',
  'skills/nova/pipeline/portable-artifacts.ts',
  'skills/nova/pipeline/platform-config.ts',
  'skills/nova/pipeline/egress.ts',
  'skills/nova/pipeline/redis-transport.ts',
  'skills/nova/pipeline/run-discovery.ts',
  'skills/nova/pipeline/runtime-state-paths.ts',
  'skills/nova/pipeline/security.ts',
  'skills/nova/pipeline/scheduler.ts',
  ...
  'skills/nova/pipeline/services/redis-wait.ts',
