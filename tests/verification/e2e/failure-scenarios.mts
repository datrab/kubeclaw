...
const definitions = [
  ...
  ['tailscale-exposure-url-unreachable', 'Published preview URL is unreachable.', 'final-deployment-buster', 'pre-final-buster', 'final-buster', 'nonzero', 'tailscale_exposure_url_unreachable', ['kubernetes']],
  ['tailscale-exposure-wrong-content', 'Preview serves the wrong deployment marker.', 'final-deployment-buster', 'pre-final-buster', 'final-buster', 'nonzero', 'tailscale_exposure_wrong_content', ['kubernetes']],
