...
export const AGENT_OBSERVABILITY_TELEMETRY_MAPPINGS = Object.freeze([
  ...
  },
  {
    ...
    current_telemetry_type: 'plugin.event',
    future_telemetry_type: 'agent.spawn.requested',
    promoted_by_default: true,
    notes: 'Spawn-requested remains plugin.event until a first-class spawn-request schema is approved.',
  },
  {
  ...
  },
  {
    ...
    current_telemetry_type: 'plugin.event',
    future_telemetry_type: 'plugin.event',
    promoted_by_default: true,
    notes: 'Delivery-target routing metadata remains plugin.event until a first-class subagent routing schema is approved.',
  },
  {
