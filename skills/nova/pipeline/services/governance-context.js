...
import { extractArchValidatorReport } from './arch-validator.js';
...
export function recordApprovalGateOutcome(config, gateId, gateTitle, status, decisionBy, reason, identity = {}) {
  ...
  ctx.approval_gates.push({
    ...
    state_path: `.swarm/${gateId}-gate-status.json`,
    request_path: `.swarm/logs/gates/${gateId}/approval-request.json`,
    decision_path: `.swarm/logs/gates/${gateId}/approval-decision.json`,
    artifact_path: `.swarm/logs/gates/${gateId}/approval-decision.json`,
    transitions_path: `.swarm/logs/gates/${gateId}/approval-transitions.jsonl`,
  });
