...
export function resumedBusterDispatch(
  ...
  return {
    ...
    model: selectDefinedValue(() => normalizeString(active.model), () => normalizeString(backend.model)),
    model_source: selectDefinedValue(() => normalizeString(active.model_source), () => normalizeString(backend.modelSource)),
    reasoning_level: selectDefinedValue(() => normalizeString(active.reasoning_level), () => normalizeString(backend.reasoningLevel)),
    thinking_source: selectDefinedValue(() => normalizeString(active.thinking_source), () => normalizeString(backend.thinkingSource)),
