...
export const PLUGIN_STAGE_IDS = Object.freeze({
  ...
  validator: new Set(['validator:architecture', 'validator:delivery_lint', 'validator:pre_check']),
...
export const PLUGIN_REQUIRED_CAPABILITIES = Object.freeze({
  worker: ['read.state', 'read.artifacts', 'emit.stream', 'emit.telemetry', 'write.artifacts', 'dispatch.worker_backend'],
...
export const PLUGIN_FORBIDDEN_CAPABILITIES = Object.freeze({
  worker: [],
  gate: ['dispatch.worker_backend'],
  validator: ['request.wait', 'request.signal', 'dispatch.worker_backend'],
  generator: ['request.wait', 'request.signal', 'dispatch.worker_backend'],
  notification: ['request.wait', 'request.signal', 'dispatch.worker_backend'],
});
...
export const PLUGIN_REJECTION_CODES = Object.freeze({
  ...
  REGISTRY_STAGE_OWNER_UNKNOWN: 'REGISTRY_STAGE_OWNER_UNKNOWN',
