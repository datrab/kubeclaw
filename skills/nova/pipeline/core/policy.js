...
//                          or legacy progress.models[agentName]
 ...
 *                             progress.defaults.models[name] or legacy
 *                             progress.models[name], plus
 *                             progress.defaults.thinking[name].
...
export function resolvePolicy(config, progress, agentName, opts = {}) {
  ...
  const modelCandidates = [
    ...
    [normalize(progress?.defaults?.models?.[agentName] ?? progress?.models?.[agentName]), 'project_default'],
