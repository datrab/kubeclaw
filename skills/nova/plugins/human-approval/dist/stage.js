import { APPROVAL_SIGNAL_TYPE, calculateApprovalExpiresAt, parseApprovalConfig, parseApprovalGuidance, parseApprovalInput, pendingApprovalResult, resultForApprovalGuidance, validateCreatedWait, } from './approval.js';
export async function execute(rawInput, context) {
    ...
    if (guidance.decision !== 'pending')
        return resultForApprovalGuidance(guidance);
