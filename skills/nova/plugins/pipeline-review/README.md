...
The optional reviewer produces an assessment across five required dimensions.
Each observation must cite selected source evidence; suggestions remain advisory.
