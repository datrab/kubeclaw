...
try{
 ...
 const enabled=new Set(['kubeclaw.buster-quality-gate:quality']);const granted=core.resolveCapabilityGrants(snapshot,{enabledRegistrations:enabled,
  ...
  grants:new Map([['kubeclaw.buster-quality-gate:quality',new Map([['runtime.dispatch',{allowedAgents:['gate']}],['artifacts.write',{namespace:'kubeclaw.buster-quality-gate'}]])],
