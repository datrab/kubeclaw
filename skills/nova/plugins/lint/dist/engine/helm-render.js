...
function renderChart(ctx, chartDir) {
    ...
    if (rendered.exitCode !== 0 || !rendered.stdout.trim())
        failParse(ctx, 'helm-template', { error: 'render failed or produced no manifests' }, rendered, chartDir);
