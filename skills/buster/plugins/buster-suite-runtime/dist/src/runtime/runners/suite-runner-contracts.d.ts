...
export type SuiteResult = SuiteVerdict & {
...
export declare function createSuiteRunnerValidationError(message: string, details: SuiteRunnerValidationDetails): SuiteRunnerValidationError;
export {};
