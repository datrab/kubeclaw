...
function repositoryWithoutTag(image) {
...
function readDigest(metadataPath) {
...
export async function buildAndPushImage({ dockerfile, contextDir, image, timeoutMs, log = () => { }, execFileAsync = execFileAsyncDefault, }) {
