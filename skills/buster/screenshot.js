...
//   node screenshot.js --generate-baselines <preview.html> <output-dir/>
 ...
 * Used by visual-reg.js for multi-path comparison against running app.
 *
...
if (__currentFile === __entryFile) {
  ...
  if (getFlag('generate-baselines')) {
    ...
    if (!htmlPath || !outputDir) {
      console.error('Usage: node screenshot.js --generate-baselines <preview.html> <output-dir/>');
      process.exit(2);
    }
    ...
    if (!target || !outputPath) {
      ...
      console.error('       node screenshot.js --generate-baselines <preview.html> <output-dir/>');
      process.exit(2);
    }
