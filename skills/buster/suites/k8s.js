...
//
// Writes /sandbox/k8s-test-namespace so the Buster Pipeline can
...
export default async function k8sSuite(context) {
  ...
  if (!criticalFailed) {
    ...
    try {
      ...
      fs.writeFileSync(K8S_NS_FILE, testNs);   // Buster Pipeline cleanup reads this
