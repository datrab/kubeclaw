...
for (const child of [application, tailscale, ops, redis, registryMirror, registryLocal, ...monitoringApplications]) {
...
for (const [name, object] of [['infra-project', project], ['data-project', dataProject], ['argocd', application], ['tailscale-operator', tailscale], ['codex-ops', ops], ['redis', redis], ['registry-mirror', registryMirror], ['registry-local', registryLocal], ['monitoring-project', monitoringProject], ...monitoringApplications.map(app => [app.metadata.name, app]), ['../platform', platform]]) {
