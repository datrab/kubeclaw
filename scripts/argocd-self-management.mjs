...
for (const [name, object] of [['infra-project', project], ['data-project', dataProject], ['argocd', application], ['tailscale-operator', tailscale], ['codex-ops', ops], ['redis', redis], ['../platform', platform]]) {
