...
Standard: `/home/node/.openclaw/swarm.config.json`; `SWARM_CONFIG` ist nur ein expliziter Override fuer abweichende Runtime-Config-Pfade. Steuert Pipeline-Verhalten — wird selten geändert.
