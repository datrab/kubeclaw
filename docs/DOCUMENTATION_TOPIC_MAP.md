...
| Cilium networking | `docs/ops/cilium-quickstart.md`; `docs/ops/cilium-networking.md` | `my-values/infra/cilium-values.yaml`; `my-values/infra/cilium-cluster-policies.yaml`; `my-values/infra/network-policies.yaml`; `scripts/deploy-cilium.sh`; `scripts/migrate-kubeclaw-network-policies-to-cilium.sh` |
