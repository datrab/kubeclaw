...
Do not treat this file as the current missing-page list. Current coverage and priorities live in the 2026-06-12 audit artifacts:
...
Example subdirectories now contain committed README/JSON/value examples in the active docs tree. Treat additional example files as future enrichment work only when the coverage matrix or changelog identifies a source-backed gap.
