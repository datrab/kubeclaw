...
| `my-values/buster-values.yaml` | `agentRole`, `anthropic`, `busterPipeline`, `gateway`, `image`, `imagePullSecrets`, `auth`, `litellm`, `discord`, `commands`, `discordWebhook`, `probes`, `agent`, `sandbox`, `serviceAccount`, `busterNamespaceBroker`, `resources`, `workspace` | `existingSecret: openclaw-shared-secrets` at line 12<br>`existingSecret: openclaw-shared-secrets` at line 38<br>`existingSecret: openclaw-shared-secrets` at line 42<br>`existingSecret: openclaw-shared-secrets` at line 47<br>`secretName: openclaw-shared-secrets` at line 61<br>`secretName: git-deploy-key-buster` at line 77 |
