...
| `my-values/infra/qdrant-values.yaml` | `replicaCount`, `args`, `env`, `image`, `persistence`, `snapshotPersistence`, `config`, `additionalVolumes`, `additionalVolumeMounts`, `resources`, `chartTests` | `secretName: qdrant-tls` at line 41 |
