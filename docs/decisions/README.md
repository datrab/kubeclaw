...
- [Security decisions](security-decisions.md): Buster sandbox posture, custom skill boundary, secret/runtime config materialization, network policy model, and redaction.
