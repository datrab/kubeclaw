...
Last verified: 2026-09-16, source assessment only; see individual evidence
...
- Run the complete plugin-system v2 boundary check and update AP08 evidence only after it exits with status zero.
...
- AP08 documentation links to the resulting supported boundary and does not turn an implementation exception into a documented feature.
...
Reproduced during the AP08.1 source review; documentation, source and verification were compared, but no product or test implementation was changed.

- **prior verification:** The boundary command exited with status 1 on 2026-09-16 after the required generated OpenClaw contract became available.
