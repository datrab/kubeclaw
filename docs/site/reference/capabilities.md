...
| `network.http` | `kubeclaw.buster-suite-runtime:suite`<br>`kubeclaw.http:request`<br>`kubeclaw.network-http:http`<br>`kubeclaw.operator-messaging:operator`<br>`kubeclaw.runtime-dispatch:runtime`<br>`kubeclaw.runtime-dispatch:openclaw`<br>`kubeclaw.transport-publisher:publisher`<br>`kubeclaw.preflight-contract:buildkit` |
...
| `test.suite.execute` | `kubeclaw.buster-suite-runtime:suite`<br>`kubeclaw.test-agent:test`<br>`kubeclaw.buster-quality-gate:quality`<br>`kubeclaw.preflight-contract:buildkit` |
