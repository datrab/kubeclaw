...
State operations read or append namespaced records. The adapter has no update, delete, or retention operation.

The package guide explains package-specific behavior. The shared guides explain
the contract and lifecycle rules that apply to this package.

- [Package guide](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/common/plugins/state-store/README.md)
...
- Manifest: [skills/common/plugins/state-store/plugin.json](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/common/plugins/state-store/plugin.json)
...
Global registration ID: `kubeclaw.state-store:state`. This identifies the installed registration. Graphs select stage types; Buster plans select provider contract IDs or report formats. Use the guide for the relevant selection field.

Required capabilities: None.

Provided capabilities: `state.read`, `state.append`

Configuration schema: [schemas/config.schema.json](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/common/plugins/state-store/schemas/config.schema.json)
...
Read returns namespaced records; append uses an idempotency key. Reusing that key with different content fails with STATE_IDEMPOTENCY_CONFLICT. No operation updates or deletes an existing record.
...
- Manifest: [skills/common/plugins/state-store/plugin.json](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/common/plugins/state-store/plugin.json)
- Authored package guide: [skills/common/plugins/state-store/README.md](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/common/plugins/state-store/README.md)
- Module for `state`: [src/adapter.ts](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/common/plugins/state-store/src/adapter.ts)
- Test: [skills/common/plugins/state-store/tests/live-function.test.ts](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/common/plugins/state-store/tests/live-function.test.ts)
- Test: [skills/common/plugins/state-store/tests/package-boundary.test.mjs](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/common/plugins/state-store/tests/package-boundary.test.mjs)
