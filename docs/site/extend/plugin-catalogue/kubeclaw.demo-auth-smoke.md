...
- [Package guide](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/buster/plugins/demo-auth-smoke/README.md)
...
- Manifest: [skills/buster/plugins/demo-auth-smoke/plugin.json](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/buster/plugins/demo-auth-smoke/plugin.json)
...
Global registration ID: `kubeclaw.demo-auth-smoke:session`. This identifies the installed registration. Graphs select stage types; Buster plans select provider contract IDs or report formats. Use the guide for the relevant selection field.

Required capabilities: `network.http`

Provided capabilities: None.

Configuration schema: [schemas/config.schema.json](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/buster/plugins/demo-auth-smoke/schemas/config.schema.json)

Configuration fields (schema declarations; defaults are annotations, not proof that the caller inserts a value):

- `protocol` (constant; required; value `json-session.v1`)
- `loginPath` (string; required; minLength `1`; maxLength `2048`)
- `usernameKey` (string; required; minLength `1`; maxLength `2048`)
- `passwordKey` (string; required; minLength `1`; maxLength `2048`)
- `cookieName` (string; required; minLength `1`; maxLength `2048`)
- `protectedPath` (string; required; minLength `1`; maxLength `2048`)
- `usernamePointer` (string; required; minLength `1`; maxLength `2048`)
- `assertions` (array; required; minItems `1`; maxItems `16`)
...
The test requires an unauthenticated negative control, successful login, and protected business assertions. Its local integration command builds the credential producer with Go.
...
```text
node --test ../../../../tests/verification/integration/demo-auth-smoke-live.test.ts
```
...
- Manifest: [skills/buster/plugins/demo-auth-smoke/plugin.json](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/buster/plugins/demo-auth-smoke/plugin.json)
- Authored package guide: [skills/buster/plugins/demo-auth-smoke/README.md](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/buster/plugins/demo-auth-smoke/README.md)
- Module for `session`: [src/provider.js](https://github.com/datrab/kubeclaw/blob/32b02816cc19cc8865a45b221b8b6ca28e99e8fb/skills/buster/plugins/demo-auth-smoke/src/provider.js)
