...
> **Discovery boundary:** [The registry builder validates package declarations and creates separate indexes](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/skills/common/plugin-runtime/foundation/registry/build.ts#L265-L317).
>
> **Activation boundary:** [Foundation checks selected package integrity before it imports executable code](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/skills/common/plugin-runtime/foundation/registry/activation.ts#L103-L137).
...
> **Invocation boundary:** [The SDK context exposes bounded capability, event, and artifact services](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/skills/common/plugin-runtime/sdk/src/runtime.ts#L21-L43).
>
> **Result interpretation:** [Nova validates the result, records it, applies lifecycle rules, and always cleans the attempt](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/skills/nova/core/execution/stage-executor.ts#L31-L52).
...
> **Bounded delivery:** [Nova binds the observer identity, delivery attempt, lease, grants, timeout, and cleanup](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/skills/nova/core/telemetry/observer-delivery.ts#L15-L43).
...
> **Provider resolution:** [Foundation maps each capability to one installed adapter and rejects invalid mappings](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/skills/common/plugin-runtime/foundation/registry/capabilities.ts#L75-L119).
>
> **Effect recovery:** [The durable invocation records request and acceptance, recovers receipts, fences calls, and records completion](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/skills/nova/core/effects/durable-invocation.ts#L88-L157).
...
> **Provider binding:** [Buster verifies the plan digest, registry snapshot, provider identity, and report-adapter identity](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/skills/buster/engine/test-gates/runner.ts#L234-L267).
>
> **Package snapshot:** [The provider loader verifies the digest and copies exact package bytes into the attempt workspace](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/skills/buster/engine/test-gates/provider-loader.ts#L52-L79).
...
> **Attempt lifecycle:** [Worker Core invokes preparation, execution, termination, measurement, cleanup, and evidence hooks](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/skills/worker/core/worker/attempt-executor.ts#L62-L93).
>
> **Role closure:** [The role checker verifies ownership, dependencies, capability providers, and plugin selection](https://github.com/datrab/kubeclaw/blob/569f7b4933d4859cc67c80ddf40d5154ffd95ce5/scripts/check-runtime-role-manifests.mjs#L77-L145).
