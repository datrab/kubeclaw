...
The stable **D-001–D-119** identifiers name the test-gate decisions. This page contains the current rules, their reasons, and their recorded authority. Broader ownership and security reasoning is in [Core and plugin decisions](core-and-plugins.md).
