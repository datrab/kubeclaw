...
D16-Fortsetzung: Prism besitzt jetzt explizite V3-/Legacy-Auswahl für Control und Worker, nativen Start mit echter Namespace-/Capability-/Ownership-Prüfung, eng ausgewählte NRI-Anbindung und hostgebundenen Helm-/Deploy-Preflight. Originaler C-Launcher und NRI-SDK/OCI-Generator sind lokal geprüft. **137 lokal verifiziert / 17 unvollständig**, weiterhin keine zusätzliche Finding-Schließung. [Runtime-Checkpoint](implementation/pr6-native-runtime-checkpoint.md); Buster-Fixtures, vollständige Dispatch-/Replacement-Abnahme und übrige Findings bleiben in Arbeit.
