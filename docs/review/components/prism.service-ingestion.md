...
Original-Serviceprobe: [prism-ingestion-service-error-probe.mjs — historischer Stand](https://github.com/datrab/kubeclaw/blob/2121dcaae14c65c0b0608dc5fe365041b7de6242/docs/review/evidence/prism-ingestion-service-error-probe.mjs), [Ausgabe](../evidence/prism-ingestion-service-error-probe.txt). Tatsächlicher temporärer Dateisystemfehler, kein ersetztes unlink und kein Mockservice.
