...
- `skills/nova/core/observability`
...
- `docs/architecture/pipeline-test-gate-decision-ledger.json:119`
- `docs/blueprint/04-evidence-matrix.md:43`
- `tests/verification/contracts/check-pipeline-observability-nova-reconciliation.mts:20`
