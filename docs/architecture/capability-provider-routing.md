...
Adapters own authentication, transport, cancellation translation, and response
normalization. Receivers own provider-specific execution. Provider credentials
and native response formats never cross into core.
