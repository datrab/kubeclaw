...
An automatic checker cannot determine that prose is understandable or that an operator has enough information. AP11 reader journeys remain required. Language checks may flag obvious problems but must not claim formal ASD-STE100 compliance or block useful explanations through arbitrary sentence limits.
