...
Files classified: 2706. Unclassified files: 0.

| Disposition | Count |
| --- | ---: |
| delete-after-reader-coverage | 2310 |
| delete-after-replacement | 1 |
| extract-decisions-then-delete | 58 |
| extract-then-delete | 133 |
| internal-machine-authority | 4 |
| internal-only | 7 |
| keep-and-verify | 7 |
| merge-into-operator-track | 9 |
| merge-then-delete | 1 |
| move-out-of-product-docs | 2 |
| regenerate-internal | 12 |
