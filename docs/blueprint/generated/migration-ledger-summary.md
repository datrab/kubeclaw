...
Files classified: 356. Unclassified files: 0.

| Disposition | Count |
| --- | ---: |
| delete-after-replacement | 1 |
| extract-decisions-then-delete | 54 |
| extract-then-delete | 130 |
| internal-only | 7 |
| keep-and-verify | 7 |
...
| review-extract-then-delete | 82 |
| rewrite-and-keep | 24 |
| split-rewrite-then-delete | 21 |
