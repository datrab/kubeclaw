...
Files classified: 276. Unclassified files: 0.

| Disposition | Count |
| --- | ---: |
| delete-after-replacement | 1 |
| extract-decisions-then-delete | 29 |
| extract-then-delete | 118 |
| internal-only | 7 |
| keep-and-verify | 7 |
...
| review-extract-then-delete | 48 |
| rewrite-and-keep | 22 |
| split-rewrite-then-delete | 14 |
