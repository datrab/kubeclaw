...
Files classified: 344. Unclassified files: 0.

| Disposition | Count |
| --- | ---: |
| delete-after-replacement | 1 |
| extract-decisions-then-delete | 50 |
| extract-then-delete | 127 |
| internal-only | 7 |
| keep-and-verify | 7 |
...
| review-extract-then-delete | 78 |
| rewrite-and-keep | 24 |
| split-rewrite-then-delete | 20 |
