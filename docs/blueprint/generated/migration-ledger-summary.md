...
Files classified: 293. Unclassified files: 0.

| Disposition | Count |
| --- | ---: |
| delete-after-replacement | 1 |
| extract-decisions-then-delete | 33 |
| extract-then-delete | 122 |
| internal-only | 7 |
| keep-and-verify | 7 |
...
| review-extract-then-delete | 53 |
| rewrite-and-keep | 24 |
| split-rewrite-then-delete | 16 |
