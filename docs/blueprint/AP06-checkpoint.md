...
The product pages now contain 1,211 lines and approximately 8,587 words.
...
| Precise diagrams | Three diagrams have direct text alternatives. Each arrow also has a prose explanation and source evidence. |
| Glossary | The glossary defines component, lifecycle, identity, trust, and evidence terms. It also separates similar terms. |
| Code evidence | Twenty-nine source-evidence boxes link claims to revision-bound code ranges and applicable decision records. |
