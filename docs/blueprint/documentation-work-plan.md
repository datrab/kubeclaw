...
**Abschlussnachweis:** [AP07 Completion Checkpoint](AP07-checkpoint.md). AP08 ist ebenfalls abgeschlossen; sein Nachweis steht im [AP08.10-Checkpoint](AP08.10-checkpoint.md).

### AP08 — Plugins und Erweiterungen

**Abgeschlossen:** [AP08.0](AP08-plan.md) liefert die reproduzierbare Baseline mit 51 installierbaren Manifesten, 67 Pipeline-Registrierungen und zusätzlichen Erweiterungsflächen ohne eigenes Installationsmanifest. [AP08.1](AP08.1-checkpoint.md) liefert die Entscheidungshilfe. [AP08.2](AP08.2-checkpoint.md) liefert den vollständigen minimalen Pipeline-Plugin-Weg mit seinen lokalen Prüfgrenzen. [AP08.3–AP08.6](AP08.3-AP08.6-checkpoint.md) erklären die fünf gemeinsamen Verträge, Effekte und Zustand sowie die Buster- und Nova-Erweiterungen. [AP08.7–AP08.9](AP08.7-AP08.9-checkpoint.md) ergänzen Host- und Engine-Erweiterungen, den vollständigen Lebenszyklus und den geprüften 51-Paket-Katalog. [AP08.10](AP08.10-checkpoint.md) dokumentiert die unabhängige Leserprüfung, die Korrekturen und die getrennten Evidenzgrenzen. Die strikt abgegrenzte Wiederholungsprüfung bestand alle Leserwege und 50 von 51 Katalogseiten. Ihr Dokumentationsblocker und ein nicht blockierender Scope-Satz wurden korrigiert. Die fokussierte Abschlussprüfung schloss beide Findings mit `ACCEPTED`. Produktfehler und Live-Abnahmen bleiben getrennt.
