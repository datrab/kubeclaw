...
4. Suggested locations:
   ...
   - self-contained OpenClaw plugin package: `plugins/openclaw-agent-observer/`, built into `/app/openclaw-plugins/kubeclaw-agent-observer/` and loaded through `plugins.load.paths`
...
OpenClaw runtime hooks
  -> pipeline-owned, self-contained OpenClaw plugin
      - loaded from /app/openclaw-plugins/kubeclaw-agent-observer
