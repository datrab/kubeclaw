...
printf '%s' "${KUBECLAW_REGISTRY_CONFIG:?Explicit registry endpoint/transport/auth configuration is required; see docs/site/understand/platform-and-operations.md#writable-local-oci-registry}" >"$registry_contract"
